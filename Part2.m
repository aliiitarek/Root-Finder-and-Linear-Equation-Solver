...
% Last Modified by GUIDE v2.5 23-Jun-2014 20:41:42
...
tic
[X, Precision,n,ctr] = GaussElimination(A, b);
Time = toc;
set(handles.text3,'String',X)
set(handles.text1,'String',Time)
set(handles.text2,'String',Precision)
set(handles.text4,'String',n)
set(handles.text5,'String',ctr)
...
b = str2num(get(handles.edit2, 'String'));
tic
[X, Precision,n,ctr] = GaussJordon(A, b);
Time = toc;
set(handles.text3,'String',X)
set(handles.text1,'String',Time)
set(handles.text2,'String',Precision)
...
b = str2num(get(handles.edit2, 'String'));
tic
[X, Precision,n,ctr] = LUDecomposition(A, b);
Time = toc;
set(handles.text3,'String',X)
set(handles.text1,'String',Time)
set(handles.text2,'String',Precision)
